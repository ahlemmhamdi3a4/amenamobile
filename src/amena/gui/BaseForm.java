...
public class BaseForm extends Form {
    public BaseForm() {
        ...
        Button btnAddColis = new Button("Add Annonce");
        Button btnListColis = new Button("List annonce");

        btnAddColis.addActionListener(e -> new AjouterAnnonces(this).show());
        btnListColis.addActionListener(e -> new ListAnnonce(this).show());
